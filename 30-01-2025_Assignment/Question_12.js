...
let sentenceBuild = {
  ...
  updateProperty: function(property, value) {
      return this.hasOwnProperty(property) ? (this[property] = value, undefined) : "Invalid property";
  }
};

console.log(sentenceBuild.buildSentence());
sentenceBuild.updateProperty("verb", "am learning");
console.log(sentenceBuild.buildSentence());
sentenceBuild.updateProperty("subject", "The cat");
console.log(sentenceBuild.buildSentence());
console.log(sentenceBuild.updateProperty("mood", "happy"));
sentenceBuild.updateProperty("verb", "");
console.log(sentenceBuild.buildSentence());